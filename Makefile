...
docker-build:
	...
	docker build -t ${DOCKER_USER}/api:arm -f Dockerfile_arm .
	docker build -t ${DOCKER_USER}/api:arm64 -f Dockerfile_arm64 .

docker-push:
	docker login -u ${DOCKER_USER} -p ${DOCKER_PASS}
	docker push ${DOCKER_USER}/api
	docker push ${DOCKER_USER}/api:arm
	docker push ${DOCKER_USER}/api:arm64
